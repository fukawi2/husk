...
fire - wrapper to assist applying husk compiled rules

=head1 SYNOPSIS

fire [OPTIONS]

'fire' is the recommended method to compile and apply a husk ruleset.

=head1 DESCRIPTION

'fire' will manage several things automatically:
...
=item 5a. If successful, attempt to save the new rules to the appropriate
location for your distributions init scripts to load at next boot

=item 5b. If unsuccessful, restore the previous ruleset from step 2
